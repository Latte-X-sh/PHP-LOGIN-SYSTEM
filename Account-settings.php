                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="profile-info-left">
                                            ...
                                            <h4 class="user-name ">
                                                <div class="title">
                                                    Username:<?php echo "&nbsp" . htmlspecialchars($profile_data["name"]); ?></div>
                                            </h4>
                                            <h5 class="user-name ">
                                                <div class="title">
                                                    Firstname:<?php echo "&nbsp" . "&nbsp" . "&nbsp" . "&nbsp" . "&nbsp" . "&nbsp" . "&nbsp" . htmlspecialchars($profile_data["First_name"]); ?></div>
                                            </h5>
                                            <h5 class="user-name ">
                                                <div class="title">
                                                    Lastname:<?php echo "&nbsp" . "&nbsp" . "&nbsp" . "&nbsp" . "&nbsp" . "&nbsp" . "&nbsp" . htmlspecialchars($profile_data["Last_name"]); ?></div>
                                            </h5>
                                            <div class="staff-id">Employee ID : FT-0001</div>
                                            <div class="small doj text-muted">Date of Joining
                                                :<?php echo " " . htmlspecialchars($profile_data["date-created"]); ?></div>
            ...
            <div id="emp_profile" class="pro-overview tab-pane fade show active">
                <div class="row">
                                ...
                                <ul class="list-group notification-list">
                                    <li class="list-group-item">
                                        ...
                                        <a href="#" class="edit-icon" data-toggle="modal"
                                           data-target="#password_change_modal"><i class="fa fa-pencil"></i></a>
                                    </li>
                                    <li class="list-group-item">
                    ...
                    <div class="col-md-6 d-flex">
                        <div class="card profile-box flex-fill">
                            <div class="card-body">
                                <h3 class="card-title">Social Account Intergration <a href="#" class="edit-icon"
                                                                                      data-toggle="modal"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="username"
                                           placeholder="<?php echo htmlspecialchars($profile_data["name"]); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="firstname"
                                           placeholder="<?php echo htmlspecialchars($profile_data["First_name"]); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lastname"
                                           placeholder="<?php echo htmlspecialchars($profile_data["Last_name"]); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon">
                                        <input class="form-control datetimepicker" name="birthdate" type="text"
                                               placeholder="<?php echo htmlspecialchars($profile_data["date_of_birth"]); ?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" name="email"
                                           placeholder="<?php echo htmlspecialchars($profile_data["email"]); ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="country"
                                           placeholder="<?php echo htmlspecialchars($profile_data["Country"]); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="city"
                                           placeholder="<?php echo htmlspecialchars($profile_data["City"]); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="phoneno"
                                           placeholder="<?php echo htmlspecialchars($profile_data["Phone_number"]); ?>">
                                </div>
                            </div>
                        </div>
